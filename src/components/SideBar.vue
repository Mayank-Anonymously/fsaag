  ...
  <aside class="el-aside asideMenu" style="--el-aside-width: auto">
    ...
    >
      <li class="el-menu-item is-active" role="menuitem" tabindex="-1">
        <router-link
          :aria-current="[isActiveDashboard ? 'page' : '']"
          to="/dashboard"
          :class="{
      ...
      <li class="el-menu-item" role="menuitem" tabindex="-1">
        ...
        <router-link
          :aria-current="[isActiveMember ? 'page' : '']"
          :class="{
            'router-link-active router-link-exact-active': isActiveMember,
            '': !isActiveMember,
          }"
          to="/memberTree"
          >Member Tree</router-link
        >
      </li>
      <li
        :class="[isOpenReport ? 'el-sub-menu is-opened' : 'el-sub-menu']"
        role="menuitem"
        ariahaspopup="true"
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <li class="el-menu-item" role="menuitem" tabindex="-1">
                ...
                > -->
                <router-link
                  :aria-current="[isActiveWinLossSummary ? 'page' : '']"
                  :class="{
                    'router-link-active router-link-exact-active':
                      isActiveWinLossSummary,
                    '': !isActiveWinLossSummary,
                  }"
                  to="/report/winLossSummaryReport"
                  >Win / Loss Summary</router-link
                >
              </li>
              <li class="el-menu-item" role="menuitem" tabindex="-1">
                <a href="/report/adjustmentDetail" class=""
                  >Adjustment Detail</a
                >
              </li>
            </ul>
          ...
          >
            ...
            >
              <li class="el-menu-item" role="menuitem" tabindex="-1">
                <a href="/report/playerSummary" class="">Player Summary</a>
              </li>
              <li class="el-menu-item" role="menuitem" tabindex="-1">
                <a href="/report/playerTransaction" class=""
                  >Player transaction</a
                >
              </li>
              <li class="el-menu-item" role="menuitem" tabindex="-1">
                <a href="/report/playerTxnByRound" class=""
                  >By Game Round Report</a
                >
              </li>
            </ul>
          </li>
          ...
          >
            ...
            >
              <li class="el-menu-item" role="menuitem" tabindex="-1">
                <a href="/report/gameSummary" class="">Game Summary</a>
              </li>
              <li class="el-menu-item" role="menuitem" tabindex="-1">
                <a href="/report/gameDailySummary" class="">Game Daily</a>
              </li>
            </ul>
          </li>
          <li class="el-menu-item" role="menuitem" tabindex="-1">
